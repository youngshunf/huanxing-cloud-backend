...
-- 自动生成于: 2026-03-21 20:24:11.612163
...
BEGIN
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('HASN管理', 'HasnClients', '/hasn/hasn_clients', 1, 'lucide:list', 1, '/hasn/hasn_clients/index', NULL, 1, 1, 1, '', 'HASN 客户端设备表', v_parent_id, NOW(), NULL)
