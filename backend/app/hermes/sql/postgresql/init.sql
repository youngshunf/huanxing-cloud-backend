...
-- 自动生成于: 2026-04-29 18:20:35.943783+08:00
...
BEGIN
    ...
    IF v_parent_id IS NULL THEN
        ...
        VALUES ('', 'Hermes', '/hermes', 1, 'lucide:folder', 0, 'BasicLayout', NULL, 1, 1, 1, '', 'hermes模块', NULL, NOW(), NULL)
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('', 'HermesAgent', '/hermes/hermes_agent', 1, 'lucide:list', 1, '/hermes/hermes_agent/index', NULL, 1, 1, 1, '', 'Hermes Agent ', v_parent_id, NOW(), NULL)
