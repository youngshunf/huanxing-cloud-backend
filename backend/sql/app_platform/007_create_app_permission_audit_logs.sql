...
COMMENT ON COLUMN app_permission_audit_logs.agent_id IS 'Agent ID（如果是 Agent 调用）';
...
-- 外键约束
ALTER TABLE app_permission_audit_logs
    ADD CONSTRAINT fk_app_permission_audit_logs_installation
