-- =====================================================
-- HASN Human 用户表 字典数据初始化 SQL
-- 自动生成于: 2026-03-09 00:13:56.926997
-- =====================================================

-- 状态: active / suspended / deleted 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('状态: active / suspended / deleted', 'hasn_status', 'HASN Human 用户表模块-状态: active / suspended / deleted', NOW(), NULL)
ON CONFLICT (code) DO UPDATE SET name = EXCLUDED.name, remark = EXCLUDED.remark, updated_time = NOW();

-- 状态: active / suspended / deleted 字典数据
DO $$
DECLARE
