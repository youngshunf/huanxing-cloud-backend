...
v1.include_router(admin_hasn_clients_router, prefix='/clients', tags=['客户端设备'])
...
app.include_router(app_hasn_clients_router, prefix='/clients', tags=['客户端设备'])
...
agent.include_router(agent_hasn_clients_router, prefix='/clients', tags=['客户端设备'])
