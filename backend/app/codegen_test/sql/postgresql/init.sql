...
-- 自动生成于: 2026-03-12 00:18:08.249815+08:00
...
BEGIN
    ...
    IF v_parent_id IS NULL THEN
        ...
        VALUES ('', 'Codegen_test', '/codegen_test', 1, 'lucide:folder', 0, 'BasicLayout', NULL, 1, 1, 1, '', 'codegen_test模块', NULL, NOW(), NULL)
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('', 'CodegenTestTask', '/codegen_test/codegen_test_task', 1, 'lucide:list', 1, '/codegen_test/codegen_test_task/index', NULL, 1, 1, 1, '', '测试任务', v_parent_id, NOW(), NULL)
