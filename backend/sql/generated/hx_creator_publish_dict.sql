-- =====================================================
-- 发布记录表 字典数据初始化 SQL
-- 自动生成于: 2026-03-05 19:20:11.098583
-- =====================================================

-- 状态：pending/published/failed/deleted 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('状态：pending/published/failed/deleted', 'creator_status', '发布记录表模块-状态：pending/published/failed/deleted', NOW(), NULL)
ON CONFLICT (code) DO UPDATE SET name = EXCLUDED.name, remark = EXCLUDED.remark, updated_time = NOW();

-- 状态：pending/published/failed/deleted 字典数据
DO $$
DECLARE
