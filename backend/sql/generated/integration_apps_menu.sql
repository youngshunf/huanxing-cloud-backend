-- =====================================================
-- 第三方应用集成配置管理 菜单初始化 SQL (PostgreSQL)
-- 自动生成于: 2026-05-25 16:58:30.346966
...
BEGIN
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('第三方应用集成配置管理', 'IntegrationApps', '/integration/integration_apps', 1, 'lucide:list', 1, '/integration/integration_apps/index', NULL, 1, 1, 1, '', '第三方应用集成配置表', v_parent_id, NOW(), NULL)
