...
@router.get(
    ...
    name='app_get_my_hasn_likes_detail',
)
async def get_my_hasn_likes_detail(
    request: Request,
    db: CurrentSession,
...
@router.post(
    ...
    name='app_create_my_hasn_likes',
)
async def create_my_hasn_likes(
    request: Request,
...
@router.get(
    ...
    summary='获取社区点赞详情',
    dependencies=[DependsJwtAuth],
    name='app_get_my_hasn_likes',
)
async def get_my_hasn_likes(
    request: Request,
    db: CurrentSession,
    ...
    if hasn_likes.user_id != request.user.id:
...
@router.put(
    ...
    summary='更新社区点赞',
    dependencies=[DependsJwtAuth],
    name='app_update_my_hasn_likes',
)
async def update_my_hasn_likes(
    request: Request,
    db: CurrentSessionTransaction,
    pk: Annotated[int, Path(description='社区点赞 ID')],
    ...
    hasn_likes = await hasn_likes_service.get(db=db, pk=pk)
    if getattr(hasn_likes, 'user_id', request.user.id) != request.user.id:
...
@router.delete(
    ...
    summary='删除社区点赞',
    dependencies=[DependsJwtAuth],
    name='app_delete_my_hasn_likes',
)
async def delete_my_hasn_likes(
    request: Request,
    db: CurrentSessionTransaction,
    pk: Annotated[int, Path(description='社区点赞 ID')],
) -> ResponseModel:
