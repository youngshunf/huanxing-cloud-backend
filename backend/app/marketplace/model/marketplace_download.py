...
class MarketplaceDownload(Base):
    ...
    resource_type: Mapped[str] = mapped_column(sa.String(20), default='', comment='资源类型 (skill:技能:blue/template:模板:cyan)')
    resource_id: Mapped[str] = mapped_column(sa.String(100), default='', comment='资源 ID')
