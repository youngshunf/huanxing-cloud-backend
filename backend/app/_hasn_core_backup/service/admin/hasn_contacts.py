...
from backend.app.hasn_core.crud.admin.hasn_contacts import hasn_contacts_admin_dao
from backend.app.hasn_core.model import HasnContact
from backend.app.hasn_core.schema.admin.hasn_contacts import CreateHasnContactParam, DeleteHasnContactParam, UpdateHasnContactParam
