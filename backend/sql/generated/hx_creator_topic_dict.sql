-- =====================================================
-- 选题推荐表 字典数据初始化 SQL
-- 自动生成于: 2026-03-05 19:20:12.065107
-- =====================================================

-- 状态：0-待处理 1-已采纳 2-已跳过 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('状态：0-待处理 1-已采纳 2-已跳过', 'creator_status', '选题推荐表模块-状态：0-待处理 1-已采纳 2-已跳过', NOW(), NULL)
ON CONFLICT (code) DO UPDATE SET name = EXCLUDED.name, remark = EXCLUDED.remark, updated_time = NOW();

-- 状态：0-待处理 1-已采纳 2-已跳过 字典数据
DO $$
DECLARE
