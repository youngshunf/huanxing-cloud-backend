...
class HasnAgents(Base):
    ...
    name: Mapped[str] = mapped_column(sa.String(50), default='', comment='[deprecated] Agent 显示名（迁移期保留，新代码请用 display_name）')
    display_name: Mapped[str | None] = mapped_column(sa.String(100), default=None, comment='Agent 显示名（支持中文，对外展示）')
