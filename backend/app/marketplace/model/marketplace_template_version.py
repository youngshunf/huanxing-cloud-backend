...
class MarketplaceTemplateVersion(Base):
    ...
    template_id: Mapped[str] = mapped_column(sa.String(100), default='', comment='关联的模板ID')
    ...
    hermes_bundle_json: Mapped[dict | None] = mapped_column(postgresql.JSONB(), default=None, comment='Hermes bundle JSON')
