-- =====================================================
-- Rejected, invalid, duplicate, or failed lead record 字典数据初始化 SQL
-- 自动生成于: 2026-05-10 21:06:35.008593
-- =====================================================

-- source_type 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('source_type', 'lead_automation_source_type', 'Rejected, invalid, duplicate, or failed lead record模块-source_type', NOW(), NULL)
