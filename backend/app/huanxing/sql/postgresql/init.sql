...
-- 自动生成于: 2026-02-27 11:22:23.876970+08:00
...
BEGIN
    ...
    IF v_parent_id IS NULL THEN
        ...
        VALUES ('', 'Huanxing', '/huanxing', 1, 'lucide:folder', 0, 'BasicLayout', NULL, 1, 1, 1, '', 'huanxing模块', NULL, NOW(), NULL)
    ...
    IF v_menu_id IS NULL THEN
        INSERT INTO sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
        VALUES ('', 'HuanxingServer', '/huanxing/huanxing_server', 1, 'lucide:list', 1, '/huanxing/huanxing_server/index', NULL, 1, 1, 1, '', '唤星服务器', v_parent_id, NOW(), NULL)
