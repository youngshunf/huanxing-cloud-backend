...
CREATE TABLE "public"."hasn_clients" (
  ...
  "client_id"    varchar(40) COLLATE "pg_catalog"."default" NOT NULL,
  "user_hasn_id" varchar(40) COLLATE "pg_catalog"."default" NOT NULL,
  "client_type"  varchar(20) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'desktop',
...
COMMENT ON COLUMN "public"."hasn_clients"."device_info" IS '设备信息 JSON';
