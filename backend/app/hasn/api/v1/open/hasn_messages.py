...
from backend.app.hasn.schema.hasn_messages import GetHasnMessagesDetail
...
@router.get(
 ...
 name='open_open_get_hasn_messagess')
async def open_get_hasn_messagess(
    db: CurrentSession,
...
@router.get(
    '/{pk}',
    summary='获取HASN 消息详情',
 name='open_open_get_hasn_messages')
