-- =====================================================
-- Raw crawled lead page record 字典数据初始化 SQL
-- 自动生成于: 2026-05-10 21:06:34.315561
-- =====================================================

-- source_type 字典类型
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('source_type', 'lead_automation_source_type', 'Raw crawled lead page record模块-source_type', NOW(), NULL)
...
INSERT INTO sys_dict_type (name, code, remark, created_time, updated_time)
VALUES
('status', 'lead_automation_status', 'Raw crawled lead page record模块-status', NOW(), NULL)
ON CONFLICT (code) DO UPDATE SET name = EXCLUDED.name, remark = EXCLUDED.remark, updated_time = NOW();
